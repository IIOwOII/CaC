...
public class IniLogScannerProcedure {
	public static void execute(LevelAccessor world) {
		...
		CacModVariables.Log_scanner = new File((CacModVariables.MapVariables.get(world).Dir_behaviors + "/" + CacModVariables.MapVariables.get(world).Exp_session), File.separator + "log_scanner.json");
		try {
