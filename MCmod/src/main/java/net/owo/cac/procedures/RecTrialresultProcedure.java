...
public class RecTrialresultProcedure {
	public static void execute(LevelAccessor world) {
		...
		{
			try {
				BufferedReader bufferedReader = new BufferedReader(new FileReader(CacModVariables.Log_trialresult));
		...
		arr_type.add(CacModVariables.MapVariables.get(world).Dat_trial_type);
		...
		arr_spawnpoint_opponent.add(CacModVariables.MapVariables.get(world).Dat_trial_spawnpoint_opponent);
		arr_winlose.add(CacModVariables.MapVariables.get(world).Dat_trial_winlose);
		arr_time.add(CacModVariables.MapVariables.get(world).Dat_time_gameplay);
		{
