...
public class TaskSpawnOpponentProcedure {
	public static void execute(LevelAccessor world) {
		...
		lst_spawnpoint = (CacModVariables.MapVariables.get(world).List_spawnpoint_opponent.get((int) CacModVariables.Dat_trial_spawnpoint_opponent)) instanceof ListTag _listTag ? _listTag.copy() : new ListTag();
