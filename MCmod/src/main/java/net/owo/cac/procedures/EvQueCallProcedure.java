...
public class EvQueCallProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		arr_content.add((CacModVariables.MapVariables.get(world).Tim_event_content + "_call"));
		...
		CacMod.queueServerWork((int) (CacModVariables.MapVariables.get(world).Tim_event_duration * 20), () -> {
			EvQueRecordProcedure.execute(world);
			EvEnvokeProcedure.execute(world, entity);
		});
	}
}
