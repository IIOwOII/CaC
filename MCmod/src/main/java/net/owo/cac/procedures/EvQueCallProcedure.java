...
public class EvQueCallProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		CacModVariables.MapVariables.get(world).Ev_content_curr = CacModVariables.MapVariables.get(world).Ev_content_next;
		...
		arr_content.add(CacModVariables.MapVariables.get(world).Ev_content_curr);
		...
		}
		{
			try {
				...
				ev_duration = obj_pool.get(CacModVariables.MapVariables.get(world).Ev_content_curr).getAsDouble();
			} catch (IOException e) {
				e.printStackTrace();
			}
		}
		...
		EvQueStackProcedure.execute(world);
	}
}
