...
public class IniLogGameplayProcedure {
	public static void execute(LevelAccessor world) {
		...
		CacModVariables.Log_gameplay = new File((CacModVariables.MapVariables.get(world).Dir_behaviors + "/" + CacModVariables.MapVariables.get(world).Exp_session), File.separator + "log_gameplay.json");
		try {
