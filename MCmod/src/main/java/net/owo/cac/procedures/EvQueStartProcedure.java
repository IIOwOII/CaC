...
public class EvQueStartProcedure {
	public static void execute(LevelAccessor world) {
		...
		arr_content.add((CacModVariables.MapVariables.get(world).Ev_que_content + "_start"));
		...
		CacModVariables.MapVariables.get(world).TimR_que_end = CacModVariables.MapVariables.get(world).TimR_time + CacModVariables.MapVariables.get(world).Ev_que_waittime * 20;
		CacModVariables.MapVariables.get(world).syncData(world);
		CacModVariables.MapVariables.get(world).TimR_que_switch = true;
		CacModVariables.MapVariables.get(world).syncData(world);
	}
}
