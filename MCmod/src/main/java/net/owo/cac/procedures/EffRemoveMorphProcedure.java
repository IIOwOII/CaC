...
public class EffRemoveMorphProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		entity.stopRiding();
		if (entity instanceof LivingEntity _livEnt1 && _livEnt1.hasEffect(CacModMobEffects.EFF_MORPH_PREDATOR.get())) {
			if (entity instanceof LivingEntity _entity)
				_entity.removeEffect(CacModMobEffects.EFF_MORPH_PREDATOR.get());
		}
		if (entity instanceof LivingEntity _livEnt3 && _livEnt3.hasEffect(CacModMobEffects.EFF_MORPH_PREY.get())) {
			if (entity instanceof LivingEntity _entity)
		...
		}
		{
			...
			if (!_ent.level().isClientSide() && _ent.getServer() != null) {
				_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
						_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), "kill @e[type=cac:ent_pseudo_cat]");
			}
		}
		{
			Entity _ent = entity;
			if (!_ent.level().isClientSide() && _ent.getServer() != null) {
				_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
						_ent.getName().getString(), _ent.getDisplayName(), _ent.level().getServer(), _ent), "kill @e[type=cac:ent_pseudo_mouse]");
			}
		}
	}
}
