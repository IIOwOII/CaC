...
public class FncFieldWallProcedure {
	public static Vec3 execute(LevelAccessor world, Entity entity) {
		...
		for (Tag dataelementiterator : list_line) {
			...
			vec_PA = (new Vec3(((double) ((list_vertice_start.get(0)) instanceof IntTag _intTag ? _intTag.getAsInt() : 0)), 0, ((double) ((list_vertice_start.get(1)) instanceof IntTag _intTag ? _intTag.getAsInt() : 0)))).subtract(vec_P);
			vec_PB = (new Vec3(((double) ((list_vertice_end.get(0)) instanceof IntTag _intTag ? _intTag.getAsInt() : 0)), 0, ((double) ((list_vertice_end.get(1)) instanceof IntTag _intTag ? _intTag.getAsInt() : 0)))).subtract(vec_P);
