...
public class FncManageTasktypeProcedure {
	public static void execute(LevelAccessor world) {
		...
		} else if ((CacModVariables.MapVariables.get(world).Exp_session).equals("test_chasing") || (CacModVariables.MapVariables.get(world).Exp_session).equals("pseudo_chasing")) {
			CacModVariables.MapVariables.get(world).Dat_trial_type = 0;
			CacModVariables.MapVariables.get(world).syncData(world);
		} else if ((CacModVariables.MapVariables.get(world).Exp_session).equals("test_chased") || (CacModVariables.MapVariables.get(world).Exp_session).equals("pseudo_chased")) {
