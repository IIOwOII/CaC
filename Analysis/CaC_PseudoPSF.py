...
dir_beh = [f'{dir_main}/{subj}/{task}' for subj in subjs]

log_event = []
log_gameplay = []
log_position = []
for beh in dir_beh:
    with open(f'{beh}/log_event.json') as f:
        log_event.append(json.load(f)['cac'])
    with open(f'{beh}/log_gameplay.json') as f:
        log_gameplay.append(json.load(f)['cac'])
    with open(f'{beh}/log_position.json') as f:
        log_position.append(json.load(f)['cac'])
